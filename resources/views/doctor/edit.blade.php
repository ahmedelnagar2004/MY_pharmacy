        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="fw-bold m-0">
                    <i class="fas fa-user-md me-2"></i>تعديل بيانات الطبيب
                </h2>
                <p class="text-muted mb-0 mt-1">تعديل بيانات الطبيب: {{ $doctor->name }}</p>
            </div>
            <div>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('doctor.update', $doctor->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price', $doctor->price) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('number') is-invalid @enderror" id="number" name="number" value="{{ old('number', $doctor->number) }}" required>
                                                @error('number')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="image" class="form-label">صورة الطبيب</label>
                                        <div class="image-preview text-center mb-2">
                                            <img id="preview-image" src="{{ asset('storage/' . $doctor->image) }}" alt="{{ $doctor->name }}" class="img-fluid rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
                                        </div>
                            ...
                            <div class="d-flex justify-content-end pt-3 border-top">
                                <a href="{{ route('doctor.index') }}" class="btn btn-light me-2">إلغاء</a>
